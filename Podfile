...
target 'LinkApp' do
  ...
  pod 'TIoTLinkThirdPartyKit/TPNS-iOS', '2.2.1-beta.202108030939'
  pod 'TIoTLinkThirdPartyKit/WechatOpenSDK_NoPay', '2.2.1-beta.202108030939'
end
...
target 'LinkSDKDemo' do
  ...
  pod 'TIoTLinkThirdPartyKit/IJKPlayer-iOS', '2.2.1-beta.202108030939'
end
