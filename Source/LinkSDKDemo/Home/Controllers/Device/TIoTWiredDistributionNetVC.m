...
- (void)setupUI {
    ...
    self.port.placeholder = @"收到信息后请输入port";
...
- (void)broadcastWithMessage:(NSDictionary *)message{
    ...
    [self.socket sendData:[NSJSONSerialization dataWithJSONObject:message?:@{} options:NSJSONWritingPrettyPrinted error:nil] toHost:@"255.255.255.255" port:self.portString.intValue withTimeout:10 tag:100];
