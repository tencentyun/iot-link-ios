...
@class TIoTDemoDeviceAudioModel;
@class TIoTDemoDeviceVideoModel;

@interface TIoTDemoDeviceStatusModel : NSObject
@property (nonatomic, copy) NSString *status;
@property (nonatomic, copy) NSString *appConnectNum;
@property (nonatomic, copy) NSString *video_list;
@property (nonatomic, strong) TIoTDemoDeviceVideoModel *video;
@property (nonatomic, strong) TIoTDemoDeviceAudioModel *audio;
@end

@interface TIoTDemoDeviceAudioModel : NSObject
...
@interface TIoTDemoDeviceVideoModel : NSObject
@property (nonatomic, copy) NSString *codecid;
