...
- (UIButton *)deviceControlButton {
    if (!_deviceControlButton) {
        ...
        [self setButtonFormateWithButton:_deviceControlButton titlt:NSLocalizedString(@"manualIntelligent_deviceControl", @"设备控制") titleColorHexString:@"#15161A" font:[UIFont wcPfRegularFontOfSize:16]];
...
- (UIButton *)delayButton {
    if (!_delayButton) {
        ...
        [self setButtonFormateWithButton:_delayButton titlt:NSLocalizedString(@"manualIntelligent_delay", @"延迟") titleColorHexString:@"#15161A" font:[UIFont wcPfRegularFontOfSize:16]];
...
- (UIButton *)cancelButton {
    if (!_cancelButton) {
        ...
        [self setButtonFormateWithButton:_cancelButton titlt:NSLocalizedString(@"cancel", @"取消") titleColorHexString:@"#15161A" font:[UIFont wcPfRegularFontOfSize:16]];
    }
