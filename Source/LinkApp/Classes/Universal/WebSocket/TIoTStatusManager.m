...
@interface TIoTStatusManager ()//<TRTCCallingViewDelegate,TIoTTRTCSessionUIDelegate>
{
...
//                UIViewController *topVC = [TIoTCoreUtil topViewController];
    ...
    }else if (type == TIoTTRTCSessionCallType_video) {
...
//                UIViewController *topVC = [TIoTCoreUtil topViewController];
                if (type == TIoTTRTCSessionCallType_video) {
                    [self exitRoom:deviceParam._sys_userid];
                }
            }
        });
...
- (BOOL)isActiveCalling:(TIOTtrtcPayloadParamModel *)deviceParam {
    deviceIDTempStr = deviceParam.deviceName?:@"";
...
//    UIViewController *topVC = [TIoTCoreUtil topViewController];
    ...
    if (TIoTTRTCSessionCallType_audio == type || TIoTTRTCSessionCallType_video == type) {
