...
//            NSString *dataTypeString = propertyDic[@"dataType"]?:@"";
            ...
            if (![NSString isNullOrNilWithObject:dataTypeString]) {
                if ([dataTypeString isEqualToString:@"int"]) {
//                    //type
//                    NSString *typeString = @"00";
//                    //property value  TVL
//                    //IdValueString
//                    NSInteger IDNumber = [self getPropertyIndexWithType:dataTypeString];
//
//                    NSString *valueString = @"";
//                    if ([dic.allKeys containsObject:idString]) {
//                        NSNumber *valueNumber = dic[idString]?:@(0);
//                        //头字节
//                        NSString *typeValueString = [self getTLVIDValue:IDNumber type:1];
//
//                        NSString *valueHex = [self getTLVValue:valueNumber.integerValue type:1];
//                        valueString = [NSString stringWithFormat:@"%@%@",typeValueString,valueHex];
//                        //length
//                        NSString *lengthString = @"0005";
//
//                        //写入设备
...
//
//                        //头字节
//                        NSString *typeValueString = [self getTLVIDValue:IDNumber type:0];
//
//                        NSString *valueHex = [self getTLVValue:valueNumber.integerValue type:0];
//                        valueString = [NSString stringWithFormat:@"%@%@",typeValueString,valueHex];
//
//                        //length
...
- (NSInteger )getPropertyIndexWithType:(NSString *)dataTypeString {
...
- (void)setPropertyReportDeviceInfoWithType:(TIoTDataTemplatePropertyType)typeValue reportDic:(NSDictionary *)dic idString:(NSString *)idString dataTypeString:(NSString *)dataTypeString {
    ...
    if ([dic.allKeys containsObject:idString]) {
        ...
        //头字节
        NSString *typeValueString = [self getTLVIDValue:IDNumber type:typeValue];
