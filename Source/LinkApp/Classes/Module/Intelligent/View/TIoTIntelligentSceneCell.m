...
- (void)setupSubview {
    ...
    [self.backImageView setImageWithURLStr:@"https://main.qcloudimg.com/raw/c05e0ef33ff62962a089649800cd5ce9/scene1.jpg" placeHolder:@""];
...
//    [self.sceneButton setImage:[UIImage imageNamed:@"intelligent_manual_switch"] forState:UIControlStateNormal];
    ...
    [self.sceneName setLabelFormateTitle:@"testtitle" font:[UIFont wcPfMediumFontOfSize:16] titleColorHexString:@"#ffffff" textAlignment:NSTextAlignmentLeft];
    ...
    [self.sceneDeviceNum setLabelFormateTitle:@"testsubtitle" font:[UIFont wcPfRegularFontOfSize:12] titleColorHexString:@"#ffffff" textAlignment:NSTextAlignmentLeft];
