...
@interface TIoTCustomSlider ()
@property (nonatomic, assign, readwrite) CGFloat sliderThumbRectOriginX;
@property (nonatomic, assign, readwrite) CGFloat sliderThumbRectWidth;
@end
