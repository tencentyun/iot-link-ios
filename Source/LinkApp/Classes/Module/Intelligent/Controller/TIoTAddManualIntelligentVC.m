...
- (UIView *)customHeaderView {
    if (!_customHeaderView) {
        ...
        UIImageView *addManualImage = [[UIImageView alloc]init];
        addManualImage.image = [UIImage imageNamed:@"addManual_Intelligent"];
        [headerContentView addSubview:addManualImage];
        [addManualImage mas_makeConstraints:^(MASConstraintMaker *make) {
...
- (TIoTIntelligentBottomActionView *)nextButtonView {
    if (!_nextButtonView) {
        ...
        [_nextButtonView bottomViewType:IntellignetBottomViewTypeSingle withTitleArray:@[NSLocalizedString(@"next", @"下一步")]];
