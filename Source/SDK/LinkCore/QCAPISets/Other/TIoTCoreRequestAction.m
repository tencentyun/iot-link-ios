...
NSString *const AppDeviceDynamicRegister = @"AppDeviceDynamicRegister"; //设备动态注册
...
NSString *const DescribeCloudStorageStreamData = @"DescribeCloudStorageStreamData"; //拉取图片流数据
