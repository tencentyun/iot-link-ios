...
- (UITextField *)phoneAndEmailTF {
    if (!_phoneAndEmailTF) {
        ...
        NSAttributedString *ap = [[NSAttributedString alloc] initWithString:@"手机号码/邮箱地址" attributes:@{NSForegroundColorAttributeName:[UIColor colorWithHexString:@"#888888"],NSFontAttributeName:[UIFont systemFontOfSize:16]}];
...
- (UITextField *)verificationcodeTF {
    if (!_verificationcodeTF) {
        ...
        NSAttributedString *apVerification = [[NSAttributedString alloc] initWithString:@"验证码" attributes:@{NSForegroundColorAttributeName:[UIColor colorWithHexString:@"#888888"],NSFontAttributeName:[UIFont systemFontOfSize:16]}];
...
- (UITextField *)passwordTF {
    if (!_passwordTF) {
        ...
        NSAttributedString *passwordAttStr = [[NSAttributedString alloc] initWithString:@"密码" attributes:@{NSForegroundColorAttributeName:[UIColor colorWithHexString:@"#888888"],NSFontAttributeName:[UIFont systemFontOfSize:16]}];
...
- (void)phoneLoginWith:(NSDictionary *)tmpDic {
    [[TIoTRequestObject shared] postWithoutToken:AppGetToken Param:tmpDic success:^(id responseObject) {
        ...
        [self loginSuccessWithResponseData:responseObject];
...
- (void)loginSuccessWithResponseData:(id)responseObject {
