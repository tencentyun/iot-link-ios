...
@interface TIoTNewVersionTipView () <UITableViewDataSource, UITableViewDelegate, UIGestureRecognizerDelegate>
...
- (void)setupUI{
    ...
    packageSizeLabel.text = @"安装包大小：30.23M";
    ...
    releaseTimeLabel.text = @"发布时间：2020/06/19";
