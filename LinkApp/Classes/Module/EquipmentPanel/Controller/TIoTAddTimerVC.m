...
//            slideView.dic = pro;
            ...
            if ([pro[@"id"]isEqualToString:@"Temperature"]) {
                NSDictionary *userconfig = pro[@"Userconfig"];
                [tempUnitDic setValue:[self changeTemperatureValue:tempUnitDic[@"max"] userConfig:@"F"] forKey:@"max"];
...
//            NSString *timeStamp = [NSString getNowTimeStingWithTimeZone:@"America/Detroit" formatter:@"HH:mm"];
